...
class CanceledDeposits extends Component {
    use WithPagination;
    ...
    public function render() {
        ...
        $query->where('status', TransactionEnum::STATUS['CANCELED']);
        $query->orWhere('status', TransactionEnum::STATUS['FAILED']);
        ...
        return view('livewire.admin.deposits.canceled-deposits', [
