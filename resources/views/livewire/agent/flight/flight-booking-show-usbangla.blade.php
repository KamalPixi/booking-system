                    ...
                    <div class="row px-0 mx-0">
                        <div class="col-md-4 d-flex align-items-center">
                            ...
                            <div class="d-flex flex-column">
                                <a href="" class="text-3 text-dark  mr-2">{{ \App\Models\Airline::where('code', $segment['AirlineDesignator'])->first()->name  }}</a>
                        ...
                        <div class="col">
                            <div class="text-center d-inline-block">
                                ...
                                <span class="badge bg-offwhite text-gray px-4 text-2">
                                    {{ $segment['OriginCode'] }} <br>
                                    <small class="font-weight-normal">
                                        {{\App\Helpers\UtilityHelper::cityCodeToName($segment['OriginCode'])}}
                                    </small>
                                </span>
                        ...
                        <div class="col">
                            <div class="text-center d-inline-block" >
                                ...
                                <span class="badge bg-offwhite text-gray px-4 text-2">
                                    {{ $segment['DestinationCode'] }} <br>
                                    <small class="font-weight-normal">
                                        {{\App\Helpers\UtilityHelper::cityCodeToName($segment['DestinationCode'])}}
                                    </small>
                                </span>
        ...
        <aside class="col-lg-4 mt-4 mt-lg-0">
            ...
            <div class="bg-white shadow-md rounded p-3 mb-2">
                <table class="w-100">
                    ...
                    <tr>
                        <td>Time limit</td>
                        <td>: <span class="text-1 font-weight-500 badge badge-secondary">{{ date('d-M-Y h:m a', strtotime($airBooking->ticketing_last_datetime)) }}</span></td>
                    </tr>
                </table>
            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="text-1 font-weight-500 text-dark">
                                : {{ $airBooking->currency }}
                                {{ $airBooking->totalBaseFareUSBangla() }}
                            </span>
                        </td>
                    </tr>
                    <tr>
