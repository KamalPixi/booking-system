<div>
    ...
    <div class="row mx-0">
            ...
            <div class="row rounded bg-white pb-3 mb-3 mx-1">
                ...
                <div class="row px-0 mx-0">
                    <div class="col-md-3 d-flex align-items-center">
                        <img class="mr-2 rounded" src="https://tbbd-flight.s3.ap-southeast-1.amazonaws.com/airlines-logo/{{$flightJson['airline']}}.png" alt="airline" width="40">
                        <div class="d-flex flex-column">
                            <a href="" class="text-3 text-dark  mr-2">{{  \App\Models\Airline::where('code', $flightJson['airline'])->first()->name ?? $flightJson['airline']}}</a>
                            {{-- <small class="text-muted d-block">Flight No:</small> </span> --}}
                        </div>
                    </div>
                    <div class="col">
                        <div class="text-center d-inline-block">
                            <span class="badge bg-offwhite text-gray px-4 text-2">
                                ...
                                <small class="font-weight-normal">
                                    {{\App\Helpers\UtilityHelper::cityCodeToName($flightJson['from'])}}
                                </small>
                            </span>
                            <div class="text-small bg-light mt-1 text-gray rounded">{{ date('d F Y', strtotime($flightJson['depart_date'])) }}</div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="h-100 pl-0 d-flex flex-column justify-content-center">
                            @if (empty($flightJson['transit_location']))
                                <small class="pl-1">Direct</small>
                            @else
                                <div class="d-inline-block">
                                    <div class="d-inline-block text-center line-height-1">
                                        <small class="pl-1 font-weight-bold">Transit time & Location</small> <br>
                                        {{ $flightJson['transit_time'] }} <br>
                                        <small class="pl-1">{{ $flightJson['transit_location'] }}</small>
                                    </div>
                                </div>
                            @endif
                        </div>
                    ...
                    <div class="col">
                        <div class="text-center d-inline-block" >
                            <span class="badge bg-offwhite text-gray px-4 text-2">
                                {{ $flightJson['to'] }} <br>
                                <small class="font-weight-normal">
                                    {{\App\Helpers\UtilityHelper::cityCodeToName($flightJson['to'])}}
                                </small>
                            </span>
                            <div class="text-small bg-light mt-1 text-gray rounded">{{ date('d F Y', strtotime($flightJson['arrival_date'])) }}</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="accordion" id="accordionFlush_1">
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="flush-heading_1">
                            <button class="accordion-button show collapsed text-uppercase font-weight-bold text-2 text-dark" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse_1" aria-expanded="false" aria-controls="flush-collapse_1">
                                Passeger Informations
                            </button>
                        </h2>
                        <div id="flush-collapse_1" class="accordion-collapse collapsed show collapse" aria-labelledby="flush-heading_1" data-bs-parent="#accordionFlush_1">
        ...
        <aside class="col-lg-4 mt-4 mt-lg-0">
            <div class="bg-white shadow-md rounded p-3 mb-2">
                <table class="w-100">
                    <tr>
                        <td>Ticket Status</td>
                        <td>
            ...
            <div class="bg-white shadow-md rounded p-3 mb-2">
                <table class="w-100">
                    ...
                    <tr>
                        <td>Time limit</td>
                        <td>: <span class="text-1 font-weight-500 badge badge-secondary"></span></td>
                    </tr>
                </table>
            </div>

            <div class="
                    bg-white shadow-md rounded p-3 mb-2
    ...
    <div wire:loading wire:target="issueTicket,partialPaymentRequest,makePartialPayment,refundRequest,togglePrint,sendTicket,printTicket,togglePrint">
        <x-loading />
    </div>
</div>
