...
<body>
    ...
    <table class="w-100 mb-4">
        @php 
            $flight = $booking->prePurchasedAirJson();
        @endphp

        <tr>
            <td style="width:13%;">
                <div class="line-height-1 d-flex flex-column">
                    <img class="rounded" src="https://tbbd-flight.s3.ap-southeast-1.amazonaws.com/airlines-logo/{{$flight['airline']}}.png" alt="logo" width="40"> <br>
                    <small class="">{{ $flight['airline'] }}</small> 
                </div>
            </td>
            <td class="" style="width:15%;">
                <h4 class="m-0 font-weight-bold text-offwhite location">{{ $flight['from'] }}</h4>
                <div class="line-height-1">
                    <span>{{ date('d F Y', strtotime($flight['depart_date'])) }}</span>
                </div>
            </td>
            ...
            <td class="" style="width:15%;">
                <h4 class="m-0 font-weight-bold text-offwhite location">{{ $flight['to'] }}</h4>
                <div class="line-height-1">
                    <span>{{ date('d F Y', strtotime($flight['arrival_date'])) }}</span>
                </div>
            </td>
            <td class="" style="line-height:1.2rem;">
                <h1 class="font-weight-bold" style="font-size:1.1rem;margin-bottom:0.4rem;">{{ $flight['airline'] }}</h1>
                <table class="w-100 table-details">
                    <tr>
                        <td class="text-uppercase">Depart</td>
                        <td class="font-weight-medium">{{ $flight['from'] }}</td>
                    </tr>
                    <tr>
                        <td class="text-uppercase">Lands In</td>
                        <td class="font-weight-medium">{{ $flight['to'] }}</td>
                    </tr>
                    <tr>
